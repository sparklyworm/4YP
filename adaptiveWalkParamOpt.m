function  fitness = adaptiveWalkParamOpt(mu)
    
    % adaptiveWalk(gene_to_fitness, N, mu, numGen, selective_pressure)
    
    % load parameter values
    load("interesting-landscape\interesting-landscape-5.mat", "N", "gene_to_fitness");
    numGen = 600;
